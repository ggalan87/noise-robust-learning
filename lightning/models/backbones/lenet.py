...
# Imported from: https://github.com/Vastlab/vast/blob/main/vast/architectures/architectures.py
# Updated with fixes from:
# https://github.com/Vastlab/vast/tree/63-network-architectures-include-bias-neuron-in-the-last-layer
