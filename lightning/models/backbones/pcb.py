...
"""
Implementation of PCB imported from https://github.com/KaiyangZhou/deep-person-reid and removed the classifier part
and relevant other code because it is handled outside the backbone in this framework
"""
...
class PCB(nn.Module):
    ...
    def forward(self, x):
        ...
        # In my framework features are normalized as needed by the loss, so no normalization here
        # I also leave the shape as-s, i.e. batch_size x dimensions x batch
        return v_h
