...
python extract_feats.py --dataset-name Cars --model-name LitInception --versions-range 203 205  --epochs-range 0 30 --batch-keys "image" "target" "target_orig" "data_idx" --parts-list "test"
