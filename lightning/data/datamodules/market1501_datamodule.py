...
class Market1501DataModule(IdentityDataModule):
    ...
    def __init__(
            ...
            dataset_args: Market1501Args = None,
            *args: Any,
            **kwargs: Any,
    ) -> None:
        super().__init__(
...
def pass_dataloader():
    ...
    dm = Market1501DataModule(data_dir="/media/amidemo/Data/object_classifier_data/datasets",
                              batch_size=64,
                              train_transforms=SoliderTrainTransforms(),
                              val_transforms=SoliderTransforms(),
                              test_transforms=SoliderTransforms(),
                              val_split=0.0,
                              dataset_args=Market1501Args(training_variant='symmetric_noise_0.5'))
    dm.setup('fit')
